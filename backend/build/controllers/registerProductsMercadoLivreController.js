...
const registerProductsMercadoLivreService_1 = require("../services/registerProductsMercadoLivreService");
...
const registerProductController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const product = yield (0, registerProductsMercadoLivreModel_1.registerProductModel)(req.body);
...
const getProductByCategoryController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const products = yield (0, registerProductsMercadoLivreService_1.getProductByCategoryService)(category);
